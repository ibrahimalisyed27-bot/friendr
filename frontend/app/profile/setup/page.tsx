    ...
    try {
      ...
      if (profilePhoto) {
        try {
          ...
          if (uploadError) {
            console.warn("Storage bucket not found, skipping photo upload:", uploadError.message)
      ...
      if (existingProfile) {
        // Update existing profile with auto-approval
        const { error: updateError } = await supabase
          ...
          .update({
            ...
            is_verified: true, // Auto-approve profile
        ...
        // Create new profile with auto-approval
        const profileData = {
          id: user.id,
      ...
      // Fallback: redirect to dashboard anyway after 3 seconds so user can continue testing
      setTimeout(() => {
        console.log("Redirecting to dashboard despite error for testing purposes...")
        router.push("/dashboard")
      }, 3000)
    } finally {
      setIsLoading(false)
        ...
        <Card className="shadow-xl border-0 bg-card/80 backdrop-blur-sm">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription className="text-base">
              Tell us about yourself to find the perfect study buddies and friends
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Photo upload is optional. Profile will work without it.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => setFormData((prev) => ({ ...prev, major: value }))} value={formData.major}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => setFormData((prev) => ({ ...prev, graduationYear: value }))} value={formData.graduationYear}>
                  <SelectTrigger>
              ...
              {error && (
                <div className="p-3 text-sm text-destructive bg-destructive/10 rounded-lg space-y-2">
                  <p>{error}</p>
                  <Button 
                    type="button" 
                    variant="outline" 
                    ...
                    className="w-full"
                  >
                    Continue to Dashboard Anyway (Testing)
                  </Button>
                </div>
              )}
              ...
              <div className="space-y-3">
                <Button
                  ...
                  disabled={isLoading || !formData.bio.trim() || !formData.major || !formData.graduationYear || formData.interests.length === 0}
                >
                ...
                <Button
                  ...
                  className="w-full"
                  onClick={() => {
                    console.log("Skipping profile setup for testing...")
                    router.push("/dashboard")
                  }}
                >
